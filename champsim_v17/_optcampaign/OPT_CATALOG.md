...
- `producer_id` remove/narrow — LSQ_ENTRY.producer_id (block.h:710) LIVE, read 6× (ooo_cpu.cc 1291/1297/1324/1332/1588/2116), UINT64_MAX sentinel.
...
| `producer_id` | u64, sentinel UINT64_MAX | **LIVE data value** (instr_id), not just a marker | 🚫 not a pack target — real id range large + read 6×. |
