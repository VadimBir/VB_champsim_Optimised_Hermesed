...
| data-packings | BLOCK 48→32B, lru/pmc/ROB/RTE-RTL-RTS/BANK_REQUEST narrowings + PACKET union | `block.h`,`instruction.h`,`ooo_cpu.h`,`memory_class.h` | footprint (~16MB@16c), not IPC | LOW-MED /item | "VERIFIED" is a **v15 static audit, never gated** — re-audit ranges/callsites + gate each |
