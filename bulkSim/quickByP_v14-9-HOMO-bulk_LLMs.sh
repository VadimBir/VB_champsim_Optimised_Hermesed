...
# =========================================================
MAX_CONCURRENT_PROCS=70

# =========================================================
# REMOTE DISPATCH CONFIG (v14-9)
# =========================================================
REMOTE_HOSTS=(10.52.3.1 10.52.0.126 10.52.3.96 10.52.2.153 10.52.0.214) # LOCAL: 10.52.0.214
...
OUT_DIR_SIGNATURE="Hx_outHOMO_LLM-shortened-BALANCED-4096-2048-1024-512-256-EMERGENCYQUICK-1c"
