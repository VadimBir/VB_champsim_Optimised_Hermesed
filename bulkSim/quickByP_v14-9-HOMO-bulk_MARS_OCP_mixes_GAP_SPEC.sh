...
# =========================================================
MAX_CONCURRENT_PROCS=120

# =========================================================
# REMOTE DISPATCH CONFIG (v14-9)
# =========================================================
REMOTE_HOSTS=(10.52.0.214) # LOCAL: 10.52.0.214
...
OUT_DIR_SIGNATURE="Hx_outHOMO_GAP-SPEC-glc_MARSwiOCP-lru-1c-"
# CHAMPSIM_DIR="champsim_v15"
CHAMPSIM_DIR="champsim_v17_DRAM"
...
priority_tier() {
  ...
  if [[ "$model" == "no no no" ]]; then
    ...
    if (( has_ocp == 0 )); then echo 1; return; else echo 2; return; fi
    # MARS+OCP mixes ALLOWED in this copy (was forbidden in HETERO_GAP)
  fi
  echo 99
}
