...
#include "hermes/xxhash32.h"   // third-party library from https://create.stephan-brumme.com/xxhash/
#include "hermes/xxhash64.h"   // third-party library from https://create.stephan-brumme.com/xxhash/
